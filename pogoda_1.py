...
Form, Window = uic.loadUiType(r"pogoda.ui") #загрузка окна "Погода"
...
Form1, Window1 = uic.loadUiType(r"glavnoeokno.ui") #загрузка главного окна
...
Form2, Window2 = uic.loadUiType(r"podscazka.ui") #загрузка окна "Подсказка"
...
Form3, Window3 = uic.loadUiType(r"nastroika.ui") #загрузка окна "Настройки"
...
def printButtonPressed(): #обработка кнопки "Поиск" на окне "Погода
    ...
    if data["cod"] != "404":
        ...
        oshibka.setStyleSheet("""
                ...
                """)
        oshibka.setWindowIcon(QIcon(r"иконка.png"))
        oshibka.setIconPixmap(QPixmap(r"ошибка.png"))
...
def podcazki(): #обработка кнопки "Получить подсказки"
    ...
    if weather == "пасмурно" or weather == "небольшая облачность" or weather == "переменная облачность": #подсказка в зависимости от погоды
        #pixmap = QPixmap(r"осень.png")
        form2.pushButton.setIcon(QIcon(r"осень.png"))
        ...
        #pixmap = QPixmap(r"зима.png")
        form2.pushButton.setIcon(QIcon(r"зима.png"))
        form2.pushButton_2.setText("Оденьтесь потеплее!")
    elif weather == "ясно":
        #pixmap = QPixmap("G://3 курс//Практика//Проект//тепло.png")
        form2.pushButton.setIcon(QIcon(r"тепло.png"))
...
def spravka(): #вывод справки (информация о программе) для окон программы
    ...
    spravka.setStyleSheet("""
        ...
        QPushButton{font: 14 pt Comic Sans MS;} 
        """)
    spravka.setWindowIcon(QIcon(r"иконка.png"))
    spravka.setIconPixmap(QPixmap(r"информация.png"))
    spravka.setText("Программа: «Программное средство «Alex.Погода»».\n\nРазработчик: Чижик Никита")
...
def pomosh(): #вывод помощи для работы с программой для пользователя
    ...
    pomosh.setStyleSheet("""
            ...
            QPushButton{font: 14 pt Comic Sans MS;} 
            """)
    pomosh.setWindowIcon(QIcon(r"иконка.png"))
    pomosh.setIconPixmap(QPixmap(r"помощь.png"))
...
def exitnastroika(): #выход из программы (окно "Настройки")
    ...
    exitnastroika.setStyleSheet("""
            ...
            QPushButton{font: 14 pt Comic Sans MS;} 
            """)
    exitnastroika.setWindowIcon(QIcon(r"иконка.png"))
    exitnastroika.setIconPixmap(QPixmap(r"выход.png"))
...
def pomoshnastroika(): #вывод помощи для работы с окном "Настройки" для пользователя
    ...
    pomoshnastroika.setStyleSheet("""
                ...
                QPushButton{font: 14 pt Comic Sans MS;} 
                """)
    pomoshnastroika.setWindowIcon(QIcon(r"иконка.png"))
    pomoshnastroika.setIconPixmap(QPixmap(r"помощь.png"))
...
def exitpogoda(): #выход из программы (окно "Погода")
    ...
    exitpogoda.setStyleSheet("""
                    ...
                    QPushButton{font: 14 pt Comic Sans MS;} 
                    """)
    exitpogoda.setWindowIcon(QIcon(r"иконка.png"))
    exitpogoda.setIconPixmap(QPixmap(r"выход.png"))
...
def exitglavnoeokno(): #выход из программы (главное окно)
    ...
    exitglavnoeokno.setStyleSheet("""
        ...
        QPushButton{font: 14 pt Comic Sans MS;} 
    """)
    exitglavnoeokno.setWindowIcon(QIcon(r"иконка.png"))
    exitglavnoeokno.setIconPixmap(QPixmap(r"выход.png"))
...
def pomoshpodscazka(): #вывод помощи для работы с окном "Подсказка" для пользователя
    ...
    pomoshpodscazka.setStyleSheet("""
                        ...
                        QPushButton{font: 14 pt Comic Sans MS;} 
                        """)
    pomoshpodscazka.setWindowIcon(QIcon(r"иконка.png"))
    pomoshpodscazka.setIconPixmap(QPixmap(r"помощь.png"))
...
def exitpodscazka(): #выход из программы (окно "Подсказка")
    ...
    exitpodscazka.setStyleSheet("""
                            ...
                            QPushButton{font: 14 pt Comic Sans MS;} 
                            """)
    exitpodscazka.setWindowIcon(QIcon(r"иконка.png"))
    exitpodscazka.setIconPixmap(QPixmap(r"выход.png"))
